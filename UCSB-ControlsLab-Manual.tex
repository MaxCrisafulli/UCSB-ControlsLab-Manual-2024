...
\begin{enumerate}
  ...
  \end{figure}
  \item Add a \texttt{HIL Write Analog} block and a \texttt{HIL Read Encoder} block to your model. They are in \texttt{QuaRC $\baro$ Data Acquisition $\baro$ Generic $\baro$ Immediate I/O}.
...
\section{Demo Model}
\begin{enumerate}
  \item Generate the \textsc{Simulink} diagram shown in Figure \ref{fig:Simulink_loopback}. The Sine wave should have a relatively low magnitude of around 0.75 and a frequency of around 1 Hz.
  \begin{figure}[H]
    \centering 
